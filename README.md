...
> **Статус:** клиент и API опубликованы двумя сервисами Cloud Run, локации и режимы мойки приезжают
> из базы. История моек пока захардкожена на клиенте — это следующая ветка.
